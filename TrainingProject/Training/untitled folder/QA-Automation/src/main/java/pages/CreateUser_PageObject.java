...
public class CreateUser_PageObject extends BaseClass {
    //add user page
    //title
    ...
    @FindBy(xpath = "//div[@id='add-user-form']//div[contains(@data-tid,'FirstName')]//input")
    public WebElement name;
    //Middle name
    @FindBy(xpath = "//div[@id='add-user-form']//div[contains(@data-tid,'MiddleName')]//input ")
    public WebElement middleName;
    //Last name
    @FindBy(xpath = "//div[@id='add-user-form']//div[contains(@data-tid,'LastName')]//input")
    public WebElement lastName;
    //Preferred name
    @FindBy(xpath = "//div[@id='add-user-form']//div[contains(@data-tid,'PreferredName')]//input")
    ...
    //Phone type
    @FindBy(xpath = "//*[@id='add-user-form']/section[2]/div/form/div[4]/div[1]/div/div/div/div[5]/i")
    ...
    //email
    @FindBy(xpath = "//div[contains(@data-tid,'UserForm-Email-Input')]")
    public WebElement email;
    //email type
    @FindBy(xpath = "//div[contains(@data-tid,'UserForm-EmailType')]")
    ...
    //Access Role
    @FindBy(xpath = "//div[@id='add-user-form']//label[contains(text(),'Access Role')]/following-sibling::input")
    ...
    @FindBy(xpath = "//div[@id='add-user-form']//label[contains(text(),'CCM')]/following-sibling::DIV")
    public WebElement enrolledCCM;
    //Enrolled Program RPM
    @FindBy(xpath = "//div[@id='add-user-form']//label[contains(text(),'RPM')]/following-sibling::DIV")
    public WebElement enrolledRPM;
    //Enrolled Program PCM
    @FindBy(xpath = "//div[@id='add-user-form']//label[contains(text(),'PCM')]/following-sibling::DIV")
    public WebElement enrolledPCM;
    //Enrolled Program BHI
    @FindBy(xpath = "//div[@id='add-user-form']//label[contains(text(),'BHI')]/following-sibling::DIV")
    public WebElement enrolledBHI;
    //Languages spoken
    @FindBy(xpath = "//div[@id='add-user-form']//label[contains(text(),'Languages Spoken')]/following-sibling::input")
    ...
    //About
    @FindBy(xpath = "//div[@id='add-user-form']//label[contains(text(),'About')]/following-sibling::textarea")
    public WebElement about ;
    //Submit
    @FindBy(xpath = "//div[@id='add-user-form']//button[contains(@data-tid,'Submit-Button')]")
    public WebElement submit ;
    //Cancel
    @FindBy(xpath = "//div[@id='add-user-form']//span[contains(text(),'Cancel')]/parent::span/parent::button")
    ...
    @FindBy(xpath = "//div[contains(text(),'User added')]")
    public WebElement addedUserValidation;
    ...
    public CreateUser_PageObject(WebDriver driver) {
        PageFactory.initElements(driver, this);
    }

    public void selectTittle(String tittle){
        try {
            //waitForVisibility(titleSelection,20);
            ...
            switch (tittle){
                case "Miss":
                    waitForVisibility(titleSelectionMiss,50);
                    titleSelectionMiss.click();
                    break;
                case "Mrs":
                    waitForVisibility(titleSelectionMrs,50);
                    titleSelectionMrs.click();
                    break;
                case "Ms":
                    waitForVisibility(titleSelectionMs,50);
                    titleSelectionMs.click();
                    break;
                case "Mr":
                    waitForVisibility(titleSelectionMr,50);
                    titleSelectionMr.click();
                    break;
                case "Mx":
                    waitForVisibility(titleSelectionMx,50);
    ...
    public void completePhone(String phoneType){
        try {
            ...
            switch (phoneType){
                ...
                case "Work":
                    phoneNumberType.click();
                    waitForVisibility(phoneNumberType,200);
    ...
    public void validationMessage(){try {
        addedUserValidation.isDisplayed();
    }catch (Exception e) {
        e.printStackTrace();
        log.error("failed due to :::" + e.getMessage());
        Assert.fail(e.getMessage());
